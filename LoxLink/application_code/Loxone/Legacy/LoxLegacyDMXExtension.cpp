...
const char * const LoxLegacyDMXExtension::DMX_DeviceTypeString(uint8_t type) const {
    ...
    case 1: return "Standard RGB";
    case 2: return "Standard RGBW";
    case 3: return "Standard Lumitech";
    case 8: return "Smart";
    case 9: return "Smart RGB";
    case 10: return "Smart RGBW";
    case 11: return "Smart Lumitech";
    }
    return "Unknown";
}
...
void LoxLegacyDMXExtension::FragmentedPacketToExtension(LoxMsgLegacyFragmentedCommand_t fragCommand, const void *fragData, int size) {
  ...
  case FragCmd_DMX_composite_actor: {
    ...
    printf("DMX composite: Type:%s, Slewrate: %d%%, Gamma:%s, Channel:%d, Data:%d %d %d %d, Time:%dms%s\n", DMX_DeviceTypeString(package->actor.Type), package->actor.Slewrate & 0x7F, gammaStr, package->actor.Channel, package->actor.Data[0], package->actor.Data[1], package->actor.Data[2], package->actor.Data[3], timeInMs, percentStr);
    break;
  }
